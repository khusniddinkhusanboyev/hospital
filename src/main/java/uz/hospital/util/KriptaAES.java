...
public class KriptaAES {
     ...
     */
    public KriptaAES(String mode, int... size) throws IllegalArgumentException {
     ...
     */
    public KriptaAES() throws IllegalArgumentException {
        this("CBC", 128);
    }
